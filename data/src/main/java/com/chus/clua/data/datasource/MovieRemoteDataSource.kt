...
class MovieRemoteDataSourceImp @Inject constructor(private val movieApi: MovieApi) : MovieRemoteDataSource {
    ...
    override suspend fun getMovieDetail(movieId: Int): Either<AppError, MovieDetailApiModel> =
    ...
    override suspend fun getMovieVideos(movieId: Int): Either<AppError, MovieVideosApiModel> =
