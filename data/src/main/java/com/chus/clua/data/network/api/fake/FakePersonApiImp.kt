...
@Singleton
class FakePersonApiImp
    @Inject
    constructor() :
    BaseFakeApi(),
        PersonApi {
        private val PersonDetailApiModel =
            PersonDetailApiModel(
                adult = false,
                alsoKnownAs =
                    listOf(
                        "Marlon Brando Jr.",
        ...
        private val PersonMovieCastApiModel =
            PersonMovieCastApiModel(
                adult = false,
        ...
        private val PersonMovieCrewApiModel =
            PersonMovieCrewApiModel(
                adult = false,
                ...
                overview =
                    "A small time thief from Belfast, Gerry Conlon, is falsely implicated in the " +
        ...
        private val PersonMovieCreditsApiModel =
            PersonMovieCreditsApiModel(
                id = 3084,
                cast = listOf(PersonMovieCastApiModel),
                crew = listOf(PersonMovieCrewApiModel),
            )

        override suspend fun getPersonDetail(personId: Int) =
            when (isLeft) {
