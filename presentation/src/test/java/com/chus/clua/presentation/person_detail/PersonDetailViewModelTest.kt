...
class PersonDetailViewModelTest : BaseViewModel() {
    ...
    @Test
    fun `when viewModel is initialized with an Either Right then it has valid PersonDetailState`() =
        runTest {
            advanceUntilIdle()
    ...
    @Test
    fun `when viewModel is initialized with an Either Left then it has valid PersonDetailState`() =
        runTest {
            advanceUntilIdle()
