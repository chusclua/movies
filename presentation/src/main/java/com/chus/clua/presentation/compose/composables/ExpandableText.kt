...
private fun PreviewExpandableText() {
    Column {
        ExpandableText(
            ...
            text = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin bibendum nisi et ipsum consequat, at interdum orci gravida. Aliquam at metus nec nisl suscipit hendrerit et at massa. Maecenas eget libero ex. Etiam finibus vel nulla scelerisque cursus. Duis porta dignissim mauris ac elementum. Nulla facilisi. Donec sit amet dui dolor. Nam tempor condimentum efficitur. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Fusce finibus elit et enim vulputate, et accumsan lacus aliquet. Nunc varius efficitur condimentum. Duis lobortis lacus elit, ut eleifend ligula molestie ac.",
        )
    }
}